...
#### Embedded board and other hardware
...
- An embedded target board, a SIngle Board Computer (SBC); *any one of these is fine*:
  - **Raspberry Pi** (any model: Pi Zero, 3B, 4 or 5)
  - **TI BeagleBone Black (Aarch32)**
  - **TI BeaglePlay (Aarch64)**
...
- [DHT22 Digital Temperature & Humidity Sensor (suggested link](https://robu.in/product/dht22-am2302-digital-temperature-humidity-sensor/) 
